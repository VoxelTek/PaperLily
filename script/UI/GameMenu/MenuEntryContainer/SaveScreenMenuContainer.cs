...
// Type: LacieEngine.UI.SaveScreenMenuContainer
...
namespace LacieEngine.UI
{
  public class SaveScreenMenuContainer : CenterContainer, IMenuEntryContainer
  {
    ...
    public override void _EnterTree()
    {
      ...
      titledMenuFrame.MinimumSize = SaveScreenMenuContainer.MainPanelSize;
      titledMenuFrame.TitleText = "system.menu.save.game";
      titledMenuFrame.DividerTexture = "res://assets/img/ui/divider_md.png";
      this.Control = (Frame) titledMenuFrame;
      this.Menu = (IMenuEntryList) new SaveLoadMenu(SaveLoadMenu.Mode.Save, (IMenuEntryList) null, (IMenuEntryContainer) this);
