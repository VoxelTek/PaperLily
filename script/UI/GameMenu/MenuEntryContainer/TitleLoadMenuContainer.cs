...
// Type: LacieEngine.UI.TitleLoadMenuContainer
...
{
  public class TitleLoadMenuContainer : CenterContainer, IMenuEntryContainer
  {
    ...
    public override void _EnterTree()
    {
      ...
      titledMenuFrame.MinimumSize = TitleLoadMenuContainer.MainPanelSize;
