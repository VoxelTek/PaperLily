...
// Type: LacieEngine.UI.IngameSettingsMenuContainer
...
{
  public class IngameSettingsMenuContainer : Godot.Control, IMenuEntryContainer
  {
    ...
    public override void _EnterTree()
    {
      ...
      titledMenuFrame.MinimumSize = IngameSettingsMenuContainer.MainPanelSize;
      titledMenuFrame.TitleText = "system.menu.settings";
      titledMenuFrame.DividerTexture = "res://assets/img/ui/divider_lg.png";
      this.Control = (Frame) titledMenuFrame;
      this.Menu = (IMenuEntryList) new IngameSettingsMenu((IMenuEntryList) null, (IMenuEntryContainer) this);
