...
// Type: LacieEngine.UI.SettingsRevertMenuEntry
...
namespace LacieEngine.UI
{
  public class SettingsRevertMenuEntry : IMenuEntry
  {
    ...
    public SettingsRevertMenuEntry(IMenuEntryList menu) => this.Parent = menu;
    ...
    public void Accept()
    {
      ...
      {
        int num = (int) new Directory().Remove(Game.Settings.SettingsFilename);
      }
