...
// Type: LacieEngine.Settings.VolumeTextSetting
...
namespace LacieEngine.Settings
{
  internal class VolumeTextSetting : Setting<Decimal>
  {
    ...
    {
      this.Name = "system.settings.volume.text";
      this.OwnSound = true;
      this.value = Game.Settings.VolumeText;
    }
    ...
    {
      Game.Settings.SetVolumeText(this.value);
