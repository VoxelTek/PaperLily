...
// Type: LacieEngine.Settings.VolumeBgmSetting
...
namespace LacieEngine.Settings
{
  internal class VolumeBgmSetting : Setting<Decimal>
  {
    ...
    {
      this.Name = "system.settings.volume.bgm";
      this.value = Game.Settings.VolumeBgm;
    }
    ...
    public override void Apply() => Game.Settings.SetVolumeBgm(this.value);
  }
}
