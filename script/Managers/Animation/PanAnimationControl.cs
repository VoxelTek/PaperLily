...
// Type: LacieEngine.Animation.PanAnimationControl
...
namespace LacieEngine.Animation
{
  public class PanAnimationControl : LacieAnimation
  {
    ...
    public override void UpdateToFirstFrame() => this._node.RectPosition = this._from;

    public override void UpdateToCurrentFrame()
    {
      this._node.RectPosition = this._from + this._track * (this.Elapsed / this.Duration);
    }

    public override void UpdateToFinalFrame() => this._node.RectPosition = this._to;
  }
}
