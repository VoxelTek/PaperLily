...
// Type: LacieEngine.Subgame.Chapter1.Ch1Home1fBathroom
...
{
  [Tool]
  public class Ch1Home1fBathroom : GameRoom
  {
    ...
    public override void _UpdateRoom()
    {
      ...
      {
        if (!Game.Variables.GetFlag("general.lights_home_1f_bathroom"))
          this.lightDay.Apply();
      }
      ...
      else if (Game.Variables.GetVariable("general.part_of_day") == "night" && !Game.Variables.GetFlag("general.lights_home_1f_bathroom"))
        this.lightNight.Apply();
      if (!Game.Variables.GetFlag("general.home_1f_bathroom_toilet_down"))
