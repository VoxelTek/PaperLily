...
namespace LacieEngine.Minigames
{
    public class Ch1MinigameBattleMk : Battle
    {
        ...
        public void BurnCol(int column, double time)
        {
            ...
            {
                this.BurnPanel(column, index, time);
            }
        }
        ...
        {
            Ch1MinigameBattleMk.IncineratePanelAttackInfinite incineratePanelAttackInfinite = new Ch1MinigameBattleMk.IncineratePanelAttackInfinite(this) {
                X = column,
                Y = row,
                ImpactTime = (float)time
            };
            base.AddProcess(incineratePanelAttackInfinite);
            base.AddSound(new Battle.BattleSound(this.sfxFire, (float)time));
        }
